...
All code uses **C++11** (`g++ -std=c++11 -O2`). GCC built-ins and pragmas are noted where platform-specific.
Based on techniques used by: Tourist, Errichto, neal, jiangly, Um_nik, maroonrk, ecnerwala.
...
| File | Topics |
|------|--------|
| [01 - I/O and CP Basics](01_io_and_basics.md) | Fast I/O, macros, typedefs, GCC pragmas, custom fast read |
| [02 - Time and Space Complexity](02_time_complexity.md) | Big-O, constraint->complexity table, overflow, memory |
| [03 - STL Tricks](03_stl_tricks.md) | Containers, algorithms, monotonic deque, GCC built-ins |
| [11 - Tips and Tricks](11_tips_and_tricks.md) | Contest strategy, debugging, stress testing, common bugs |
| [12 - CP Template](12_cp_template.md) | World-class ready-to-use contest template |
...
**Rule of thumb**: 10^8 simple operations = ~1 second on a modern judge.
...
Data Structures Seg tree, lazy seg tree, HLD, centroid, persistent seg tree
                PBDS ordered_set, implicit treap, seg tree beats
...
| Order statistics, rank, kth element | 22 (PBDS ordered_set) |
